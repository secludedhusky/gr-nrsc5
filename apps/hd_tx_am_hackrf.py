...
class hd_tx_am_hackrf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0.set_if_gain(35, 0)
        ...
        self.nrsc5_l2_encoder_1 = nrsc5.l2_encoder(0, 0, 24000, 2048, nrsc5.blend.ENABLE, ccc_width=24)
        self.nrsc5_l2_encoder_0 = nrsc5.l2_encoder(1, 0, 3750, 4, nrsc5.blend.ENABLE, ccc_width=1)
        self.nrsc5_l1_am_encoder_ma1_0 = nrsc5.l1_am_encoder(1, rdb=0, hpp=0, pl=0, aab=0)
        ...
        self.msg_connect((self.nrsc5_l2_encoder_1, 'ready'), (self.nrsc5_lot_encoder_0, 'ready'))
        self.msg_connect((self.nrsc5_lot_encoder_0, 'aas'), (self.nrsc5_l2_encoder_1, 'aas'))
        ...
        self.connect((self.nrsc5_l2_encoder_0, 0), (self.nrsc5_l1_am_encoder_ma1_0, 1))
        self.connect((self.nrsc5_l2_encoder_1, 0), (self.nrsc5_l1_am_encoder_ma1_0, 2))
        self.connect((self.nrsc5_psd_encoder_0, 0), (self.nrsc5_l2_encoder_0, 1))
        self.connect((self.nrsc5_sis_encoder_0, 0), (self.nrsc5_l1_am_encoder_ma1_0, 0))

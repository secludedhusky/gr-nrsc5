...
class hd_tx_am_hackrf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.nrsc5_l2_encoder_0 = nrsc5.l2_encoder(1, 0, 3750, 0, nrsc5.blend.ENABLE, ccc_width=24)
        ...
        self.connect((self.blocks_null_source_0, 0), (self.nrsc5_l1_am_encoder_ma1_0, 2))

...
class hd_tx_am_ma3_hackrf(gr.top_block):
    ...
    def __init__(self):
        ...
        self.nrsc5_l2_encoder_1 = nrsc5.l2_encoder(0, 0, 30000, 2048, nrsc5.blend.ENABLE, ccc_width=24)
        self.nrsc5_l2_encoder_0 = nrsc5.l2_encoder(1, 0, 3750, 4, nrsc5.blend.ENABLE, ccc_width=1)
        self.nrsc5_l1_am_encoder_ma3_0 = nrsc5.l1_am_encoder(3, rdb=0, hpp=0)
        ...
        self.connect((self.nrsc5_l2_encoder_0, 0), (self.nrsc5_l1_am_encoder_ma3_0, 1))
        self.connect((self.nrsc5_l2_encoder_1, 0), (self.nrsc5_l1_am_encoder_ma3_0, 2))
        self.connect((self.nrsc5_psd_encoder_0, 0), (self.nrsc5_l2_encoder_0, 1))
        self.connect((self.nrsc5_sis_encoder_0, 0), (self.nrsc5_l1_am_encoder_ma3_0, 0))
